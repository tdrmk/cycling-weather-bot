...
from bot_handlers import bot_handlers, commands as bot_commands
...
async def post_init(app):
    await app.bot.set_my_commands(bot_commands + location_commands + weather_commands + cycle_commands + schedule_commands)
    register_jobs(app)
